...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li><a class="nav-link active" href="docs.php"><i class="ti ti-file-text"></i><span
                ...
                <div class="col-12">
                    <div
                        ...
                        <div class="">
                            ...
                            <p>
                                This documentation will guide you through the setup and usage of the InApp Inventory
                                Dashboard template.
                            </p>
                        </div>
                    ...
                    <div class="">
                        <div class="">
                            ...
                            <div class="mb-4">
                                ...
                                <ol class="list-group list-group-numbered list-group-flush">
                                    <li class="list-group-item ps-0">Review the main entry point in
                                        <code>src/js/main.js</code>
                                    </li>
...
└── .gitignore          # Git ignore file
                            ...
                            <div class="mb-2">
                                ...
                                <p>
                                    For issues or questions, please refer to the documentation or create an issue in the
                                    repository. Also
                                    you can contact
