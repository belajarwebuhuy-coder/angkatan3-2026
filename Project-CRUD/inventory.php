...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="/srcassets/images/favicon_io/favicon-16x16.png">
...
<body>
                ...
                <li>
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-0">
                        <ul class="list-unstyled p-0 m-0">
                            ...
                            <li class="p-3 border-bottom ">
                                <div class="d-flex gap-3">
                                    <img src="src/assets/images/avatar/avatar-4.jpg" alt=""
                                        class="avatar avatar-sm rounded-circle" />
                                    <div class="flex-grow-1 small">
                            ...
                            <li class="p-3 border-bottom">
                                <div class="d-flex gap-3">
                                    <img src="src/assets/images/avatar/avatar-2.jpg" alt=""
                                        class="avatar avatar-sm rounded-circle" />
                                    <div class="flex-grow-1 small">
    ...
    <aside id="sidebar" class="sidebar">
        <div class="logo-area">
            <a href="dashboard.php" class="d-inline-flex"><img src="src/assets/images/logo-icon.svg" alt="" width="24">
                <span class="logo-text ms-2"> <img src="src/assets/images/logo.svg" alt=""></span>
            </a>
        </div>
        <ul class="nav flex-column">
            ...
            <li><a class="nav-link active" href="inventory.php"><i class="ti ti-box-seam"></i><span
            ...
            <li><a class="nav-link" href="create-product.php"><i class="ti ti-plus"></i><span class="nav-text">Add
                        Product</span></a></li>
            <li><a class="nav-link" href="reports.php"><i class="ti ti-receipt"></i><span
                        class="nav-text">Reports</span></a>
            </li>
            <li><a class="nav-link" href="404-error.php"><i class="ti ti-alert-circle"></i><span class="nav-text">404
                        Error</span></a>
            </li>
            <li><a class="nav-link" href="docs.php"><i class="ti ti-file-text"></i><span
                        ...
                        <table class="table mb-0 text-nowrap table-hover">
                            ...
                            <tbody>
                                <tr class="align-middle ">
                                    <td><a href=""><img src="src/assets/images/product-1.png" alt=""
                                ...
                                <tr class="align-middle">
                                    <td><a href=""><img src="src/assets/images/product-2.png" alt=""
                                ...
                                <tr class="align-middle">
                                    <td><a href=""><img src="src/assets/images/product-3.png" alt=""
                                ...
                                <tr class="align-middle">
                                    <td><a href=""><img src="src/assets/images/product-4.png" alt=""
                                ...
                                <tr class="align-middle">
                                    <td><a href=""><img src="src/assets/images/product-5.png" alt=""
                                                class="avatar avatar-md rounded" /><span class="ms-3">Portable Bluetooth
                                                Speaker</span></a>
                                    </td>
                                    <td>PRD005</td>
                                    <td>Electronics</td>
                                ...
                                <tr class="align-middle">
                                    <td><a href=""><img src="src/assets/images/product-6.png" alt=""
                                ...
                                <tr class="align-middle">
                                    <td><a href=""><img src="src/assets/images/product-7.png" alt=""
                                ...
                                <tr class="align-middle">
                                    <td><a href=""><img src="src/assets/images/product-8.png" alt=""
                                                class="avatar avatar-md rounded" /><span class="ms-3">Wireless
                                                Earphones</span></a>
                                    </td>
                                    <td>PRD008</td>
