<?php
    ...
    if (isset($_POST['save'])){
        ...
        if ($id) {
            ...
            $insert = mysqli_query($conn, "INSERT INTO users (name, email, password) VALUE ('$name','$email','$password')");
            header("location:user.php?tambah=berhasil");
        }
    };
            ...
            <div class="row">
                <div class="col-12">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-6">
                                <h1 class="fs-3 mb-1"><?php echo isset($_GET['edit']) ? 'Edit User' : 'Create User' ?>
                                </h1>
                        ...
                        <div class="col-md-6 text-end">
                            <div class="mb-6">
                                <a class="btn btn-primary btn-round text-end" href="user.php">Back</a>
                                <!-- <p>Your main content goes here…</p> -->
                            </div>
                        </div>
                    </div>
